		    ...
		    <div class="card">
			    <div class="header">
			        <div class="user-block">
			            ...
			            <span class="username" style="line-height: 40px;">tiếp cận và hiển thị</span>
			        </div>
			    </div>
			    <div class="body">
		    ...
		    <div class="card">
			    <div class="header">
			        <div class="user-block">
			            ...
			            <span class="username" style="line-height: 40px;">Tương tác bài viết</span>
			        </div>
			    </div>
			    <div class="body">
		    ...
		    <div class="card">
			    <div class="header">
			        <div class="user-block">
			            ...
			            <span class="username" style="line-height: 40px;">Số lần truy cập trang</span>
			        </div>
			    </div>
			    <div class="body">
		    ...
		    <div class="card">
			    <div class="header">
			        <div class="user-block">
			            ...
			            <span class="username" style="line-height: 40px;">Người hâm mộ Online</span>
			        </div>
		    ...
		    <div class="card">
			    <div class="header">
			        <div class="user-block">
			            ...
			            <span class="username" style="line-height: 40px;">Tuổi và giới tính</span>
			        </div>
		    ...
		    <div class="card">
			    <div class="header">
			        <div class="user-block">
			            ...
			            <span class="username" style="line-height: 40px;">Quốc gia</span>
			        </div>
			    </div>
			    <div class="body">
		    ...
		    <div class="card">
			    <div class="header">
			        <div class="user-block">
			            ...
			            <span class="username" style="line-height: 40px;">Thành phố</span>
			        </div>
			    </div>
			    <div class="body">
		    ...
		    <div class="card">
			    <div class="header">
			        <div class="user-block">
			            ...
			            <span class="username" style="line-height: 40px;">Giới thiệu và nguồn</span>
			        </div>
			    </div>
			    <div class="body">
