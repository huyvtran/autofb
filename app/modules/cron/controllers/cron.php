...
require_once APPPATH.'libraries/PHPMailer/class.PHPMailer.php';
        ...
        $mail->Username = "zinbee.automation@gmail.com";                 
        $mail->Password = "Muaha2016";                           
        //If SMTP requires TLS encryption then set it
        $mail->SMTPSecure = "tls";                           
        //Set TCP port to connect to 
        $mail->Port = 587;                                   
        
        $mail->From = "zinbee.automatio@gmail.com";
        $mail->FromName = "Zinbee";
        
        $mail->addAddress("Toantq1908@gmail.com", "Recepient Name");
