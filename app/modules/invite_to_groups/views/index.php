    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
            <div class="card">
                <div class="header">
                    <h2>
                        <i class="fa fa-ticket" aria-hidden="true"></i> <?=l("Mời bạn bè vào groups")?> 
                    </h2>
                </div>
                <div class="body pt0">
...
<iframe width="100%" height="360" src="https://www.youtube.com/embed/D594ElnRyjM" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
            </div>
        </div>
        <div class="clearfix"></div>
        <div class="clearfix"></div>
