<div class="row">
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <div class="card">
            <div class="header">
                <h2>
                    <i class="fa fa-calendar-check-o" aria-hidden="true"></i> <?=l('Add new campaign')?> 
                </h2>
            </div>
            <div class="body pt0">
                <form action="<?=cn('save_campaign')?>" data-redirect="<?=cn('')?>">
                    <div class="tab-content pt15">
                        <div role="tabpanel" class="tab-pane fade active in" id="home">
                            <div class="row">
                                <div class="col-sm-12 mb0">
                                    <b>Chọn Group Campaign</b>
                                    <select name ="campaign_group_id" class="form-control mr5 input">
                                        <?php foreach($groupCampaign as $row){ ?>
