                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mb0">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb0">
                                    <button type="button" class="btn bg-grey waves-effect btnSavePost" data-type="friend"><i class="fa fa-floppy-o" aria-hidden="true"></i> <?=l('Lưu bài')?></button>
                                    <div class="btn-group right" role="group">
                                        <button type="button" class="btn bg-light-green waves-effect btnPostnow" style="display:none"><i class="fa fa-paper-plane-o" aria-hidden="true"></i> <?=l('Post now')?></button>
...
<iframe width="100%" height="360" src="https://www.youtube.com/embed/6h4Pkht9iM0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                <div class="header">
                    <h2>
