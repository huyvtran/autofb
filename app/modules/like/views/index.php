    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			...
			<div class="card">
                <div class="header">
                    <h2>
                        <i class="fa fa-thumbs-o-up" aria-hidden="true"></i> <?=l("Like bài viết mới nhất")?> 
                    </h2>
                </div>
                <div class="body pt0">
...
<iframe width="100%" height="360" src="https://www.youtube.com/embed/wNSpS9wxUlI" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
            </div>
        </div>
